...
enum class SMaterial(val types: List<Material>): Materialsable {
    FENCE(OAK_FENCE, ACACIA_FENCE, BIRCH_FENCE, DARK_OAK_FENCE, JUNGLE_FENCE, NETHER_BRICK_FENCE, SPRUCE_FENCE),
    ...
    TRAPDOOR(OAK_TRAPDOOR, ACACIA_TRAPDOOR, BIRCH_TRAPDOOR, DARK_OAK_TRAPDOOR, IRON_TRAPDOOR, JUNGLE_TRAPDOOR, SPRUCE_TRAPDOOR),
